...
# MAGIC 
# MAGIC **Q:** How can I connect my Spark cluster to Amazon's Redshift?  
# MAGIC **A:** <a href="https://github.com/databricks/spark-redshift" target="_blank">Databricks has a specific connector for Redshift</a> that provides many advantages over other options. See <a href="https://docs.databricks.com/_static/notebooks/redshift.html" target="_blank">this notebook for starter code.</a> 
